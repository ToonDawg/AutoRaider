...
def capture_screenshot(name):
    try:
        ...
        os.makedirs(r"c:\source\AutoRaider\tests\screenshots", exist_ok=True)
        im.save(rf"c:\source\AutoRaider\tests\screenshots\{name}")
...
if __name__ == "__main__":
    ...
    print("Run completed. Check c:\\source\\AutoRaider\\tests\\screenshots\\")
